...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<CheckPhoneNumberCubit, CheckPhoneNumberState>(
        builder: (context, state) {
          if (state is CheckPhoneNumberLoadingState) {
            return const CircularProgressIndicator();
          }
          if (state is CheckPhoneNumberNotVerifyingState) {
            showToast(text: "Please register your number");
            Get.toNamed('/signupScreen');
          }
          return AbsorbPointer(
              absorbing: state is CheckPhoneNumberVerifyingState,
                          ...
                          onTap: () async {
                            ...
                            if (_formkey.currentState!.validate()) {
                              ...
                              BlocProvider.of<CheckPhoneNumberCubit>(context)
                                  .checkPhoneNumber(passwordController.text);
